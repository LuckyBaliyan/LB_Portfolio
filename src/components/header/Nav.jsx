  ...
  return (
    <nav className='mix-blend-difference text-white'>
       <div className="logo special-font tracking-wide mask flex-col md:flex-row flex gap-2">
          ...
          <p className='md:inline-block opacity-0 text-sm !text-white translate-x-[-10%] md:translate-x-0 scale-70 md:scale-100 font-light self-center anim-placeholder'>
